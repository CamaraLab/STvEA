...
```{r}
stvea_object <- ParameterScan(stvea_object, min_cluster_size_range = seq(5,20,4), min_samples_range = seq(10,40,3), n_neighbors=50, min_dist=0.1, negative_sample_rate=50)
```
