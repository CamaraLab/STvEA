...
```{r}
stvea_object <- ParameterScan(stvea_object, seq(5,20,4), seq(10,40,3), n_neighbors=50, min_dist=0.2, negative_sample_rate=50, python_dir = "inst/python", cache_dir="inst/python/tmp")
```
